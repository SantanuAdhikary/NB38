...
let emp = {
    ...
    sal : 1234567.89,
    isMarried : false,
    skills : ['html','java','django','flutter'],
    sleep : ()=>{
...
//todo:  how to traverse the array present inside object

emp.skills.map((ele)=>{
    console.log(ele)
})

// ! how to aceess function / method 
...
let student = {
     ...
     sid : 501,
     isPlayer : true,
     subjects : ['sql','java','python','webtech']
}

delete student.isPlayer;  // delete
student.sid = 450        // modify
student.age = 12         // add

console.log(student.sname)
console.log(student.sid)
console.log(student.isPlayer)
...
// this method is used to give all the keys in the form of array.
...
// this method is used to give all the values in the form of array.
...
// it is returning one nested array where all the properties(key and value pair) are stored in indivisual arrays.
...
// if the object is frozen we can't add/modify/delete any property in the object.
...
// it is similar to Object.freeze() method, here also we can't add or delete any property but we can modify the value.
...
// it is used to comine two or more than two objects and it returns one new object. 

//? syntax :
//   Object.assign(target,zd
...
let combined = Object.assign({},person,address,school)
...
// if we are using for-in loop in object, then we will get keys.
...
// ! note:  for-of loop we can't use in object.
...
employee.map((ele)=>{
  console.log("emp name is : "+ele.ename)
  console.log("emp id is : "+ele.eid)
  console.log("--------------------------------------")
})
...
products.map((ele)=>{
    console.log("product id is : ",ele.id)
    console.log("product title is : ",ele.title)
